...
# @pysnooper.snoop()
class CreateBoxEncoder(object):
    def __init__(self, model_filename, input_name="images",
                       output_name="features", batch_size=1):
        self.image_encoder = ImageEncoder(model_filename, input_name, output_name)
        self.image_shape = self.image_encoder.image_shape
        self.batch_size = batch_size

    def encoder(self, image, boxes):
        image_patches = []
        for box in boxes:
        ...
        return self.image_encoder(image_patches, self.batch_size)
...
def parse_args():
    ...
    parser.add_argument(
        ...
        "MOTChallenge structure: [sequence]/det/det.txt", default="./MOT16/train")
    parser.add_argument(
        "--output_dir", help="Output directory. Will be created if it does not"
        " exist.", default="./resources/detections/MOT16_train")
